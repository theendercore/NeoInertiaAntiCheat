...
public class ClientDataTransferHandler extends TransferHandler {
    ...
    public ClientDataTransferHandler(PublicKey publicKey, ResourceLocation modTransferID) {
    ...
    @Override
    public CompletableFuture<FriendlyByteBuf> transferMod(Minecraft ignored1, ClientHandshakePacketListenerImpl ignored2, FriendlyByteBuf ignored3, Consumer<PacketSendListener> ignored4) {
